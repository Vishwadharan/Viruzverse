        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-7">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12 items-center min-h-[85vh]">
            ...
            <div>
              ...
              {/* Stack tags */}
              <motion.div {...rise(0.4)} className="flex flex-wrap gap-2 mb-6">
                {["Flutter", "React", "Supabase", "AWS", "Realtime", "GST-Ready"].map((t) => (
                  <span key={t} className="px-3 py-1 rounded-xl text-[10px] font-mono"
                    style={{
                      background: "rgba(255,255,255,0.04)",
              ...
              {/* ✅ Legal links — only here, nowhere else on the page */}
